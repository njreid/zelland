...
public final class FragmentTerminalBinding implements ViewBinding {
  ...
  private FragmentTerminalBinding(@NonNull FrameLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static FragmentTerminalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTerminalBinding((FrameLayout) rootView, progressBar, webView);
    }
