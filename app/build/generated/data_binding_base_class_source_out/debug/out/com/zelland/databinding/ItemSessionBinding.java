...
public final class ItemSessionBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvHostInfo;
  ...
  private ItemSessionBinding(@NonNull MaterialCardView rootView, @NonNull Button btnConnect,
      @NonNull Button btnDisconnect, @NonNull TextView tvHostInfo, @NonNull TextView tvSessionTitle,
      @NonNull TextView tvStatus) {
    this.rootView = rootView;
    this.btnConnect = btnConnect;
    this.btnDisconnect = btnDisconnect;
    this.tvHostInfo = tvHostInfo;
  ...
  public static ItemSessionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvHostInfo;
      TextView tvHostInfo = ViewBindings.findChildViewById(rootView, id);
      if (tvHostInfo == null) {
        break missingId;
      }
      ...
      return new ItemSessionBinding((MaterialCardView) rootView, btnConnect, btnDisconnect,
          tvHostInfo, tvSessionTitle, tvStatus);
    }
