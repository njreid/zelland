...
class MainActivity : TauriActivity() {
    ...
    override fun onWebViewCreate(webView: WebView) {
        // Post to the decorView so this runs after create() finishes attaching
        // the WebView to the window — at onWebViewCreate time, webView.parent is
        // still null because WRY hasn't called setContentView yet.
        Log.d("MainActivity", "onWebViewCreate: posting keybar setup, webView=$webView")
        window.decorView.post {
            Log.d("MainActivity", "onWebViewCreate post: running setup, webView.parent=${webView.parent}")
